    ...
    <table border="1" class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <td><a class="btn btn-default btn-sm" href="update.html">修改</a>&nbsp;
                <a class="btn btn-default btn-sm" href="javascript:void(0)" onclick="fun(${user.email})">删除</a></td>
        </tr>
        </c:forEach>
        <tr>
...
<script>
    function fun(a) {
        location.href="${pageContext.request.contextPath}/deleteServlet?email="+a;
    }
</script>
</body>
</html>
